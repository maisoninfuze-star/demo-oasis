...
CATS = [
    dict(slug='living-room', file='living-room.html',
         ...
         img='assets/img/hero-living.jpg', alt='Living room with a cream sectional sofa, side table and wool rug',
    ...
    dict(slug='dining-room', file='dining.html',
         ...
         img='assets/img/hero-dining.jpg', alt='Dining room with a marble-top table and six upholstered chairs',
    ...
    dict(slug='bed-room', file='bedroom.html',
         ...
         img='assets/img/hero-bedroom.jpg', alt='Bedroom set with a panel bed, dresser, mirror, chest and nightstand',
    ...
    dict(slug='carpets', file='rugs.html',
         ...
         img='assets/img/hero-rugs.jpg', alt='Hand-knotted Royal Balouch rug in deep red, green and gold',
    ...
    dict(slug='decor', file='decor.html',
         ...
         img='assets/img/hero-decor.jpg', alt='Table lamp, vases and framed art styled on a fluted credenza',
    ...
    dict(slug='office', file='office.html',
         ...
         img='assets/img/hero-office.jpg', alt='Home office with a reclaimed-wood writing desk and black metal frame',
    ...
    dict(slug='custom-studio', file='custom.html',
         ...
         img='assets/img/scene-sofa-4.jpg', alt='Upholstered sofa and armchair in a custom fabric and finish',
